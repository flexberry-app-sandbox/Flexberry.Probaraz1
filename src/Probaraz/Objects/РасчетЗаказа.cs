...
namespace IIS.Probaraz
{
    ...
    public class РасчетЗаказа : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Probaraz.Номенклатура fНоменклатура;
        
        private IIS.Probaraz.Заказ fЗаказ;
        ...
        [PropertyStorage(new string[] {
                "Номенклатура"})]
        [NotNull()]
        public virtual IIS.Probaraz.Номенклатура Номенклатура
        {
            get
            {
                ...
                IIS.Probaraz.Номенклатура result = this.fНоменклатура;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Probaraz.Заказ.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Заказ"})]
        public virtual IIS.Probaraz.Заказ Заказ
        {
            get
            {
                ...
                IIS.Probaraz.Заказ result = this.fЗаказ;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РасчетЗаказаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасчетЗаказаE", typeof(IIS.Probaraz.РасчетЗаказа));
                }
            }
        }
    }
    ...
    public class DetailArrayOfРасчетЗаказа : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Probaraz.DetailArrayOfРасчетЗаказа members)

        // *** End programmer edit section *** (IIS.Probaraz.DetailArrayOfРасчетЗаказа members)
        ...
        /// </summary>
        public DetailArrayOfРасчетЗаказа(IIS.Probaraz.Заказ fЗаказ) : 
                base(typeof(РасчетЗаказа), ((ICSSoft.STORMNET.DataObject)(fЗаказ)))
        {
        }
        
        public IIS.Probaraz.РасчетЗаказа this[int index]
        {
            get
            {
                return ((IIS.Probaraz.РасчетЗаказа)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Probaraz.РасчетЗаказа dataobject)
        {
